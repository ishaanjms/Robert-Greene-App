          ...
          <div className="w-full max-w-3xl">
            <div className="mb-7 text-center">
              ...
              <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-muted-foreground">
                This chat retrieves from your Human Nature, War, Seduction, and Mastery notes before answering.
              </p>
            </div>
                ...
                <div className="flex justify-center py-4">
                  <div className="max-w-xl rounded-3xl border border-white/10 bg-white/[0.07] px-5 py-4 text-center shadow-lg shadow-black/10 backdrop-blur-sm">
                    <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
                      <ThinkingOrb state="searching" size={20} theme="dark" aria-label="Searching Greene Library" />
